      ...
      <section className="pt-32 pb-20 md:pt-40 md:pb-32 px-4">
        <div className="container mx-auto flex flex-col items-center text-center">
          ...
          <p className="mt-6 text-xl text-muted-foreground max-w-2xl">
            Discover exceptional quality and design across our curated collection of products
          </p>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row md:items-center justify-between mb-12">
            ...
            <Link href="/products" className="mt-4 md:mt-0 flex items-center text-primary hover:underline">
      ...
      <section className="bg-primary text-primary-foreground py-16">
        <div className="container mx-auto px-4 flex flex-col items-center text-center">
          ...
          <p className="text-lg mb-8 max-w-2xl">
            Sign up for our newsletter and receive a welcome discount on your first purchase
          </p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                name: "Sarah Johnson",
                comment: "The quality of products is outstanding. I've ordered multiple times and have always been impressed with both the items and the service.",
                rating: 5
              },
              {
                name: "Michael Chen",
                comment: "Fast shipping and the products look even better in person than in the photos. Will definitely be ordering again.",
                rating: 5
              },
              {
                name: "Jessica Williams",
                comment: "The attention to detail is what keeps me coming back. From packaging to the products themselves, everything is well thought out.",
                rating: 4
              }
