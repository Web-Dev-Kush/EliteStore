...
const getProductById = async (id: string) => {
  const mockProducts = {
    '1': {
      ...
      price: 299.99,
      description: 'Experience crystal-clear sound with these premium wireless headphones. Featuring active noise cancellation, 30-hour battery life, and memory foam ear cushions for all-day comfort.',
      images: [
    ...
    '2': {
      ...
      price: 349.99,
      description: 'Stay connected and track your fitness with this advanced smartwatch. Features include heart rate monitoring, GPS, water resistance up to 50 meters, and a stunning always-on Retina display.',
      images: [
